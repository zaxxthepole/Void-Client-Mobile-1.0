...
public class CommandParam {
    ...
    public static final CommandParam STANDALONE_TARGET = new CommandParam(CommandParamType.STANDALONE_TARGET);
    public static final CommandParam WILDCARD_TARGET = new CommandParam(CommandParamType.WILDCARD_TARGET);
    public static final CommandParam NON_ID_TARGET = new CommandParam(CommandParamType.NON_ID_TARGET);
